...
# Full AND / OR logic support within and between groups
# ============================================================
...
MONTHS_BACK = 1       # Filter: last N months
...
def preview_query(groups):
    query = build_query(groups)
    print("=" * 60)
    print("📋 Your keyword groups:")
...
# ── STEP 5: Run search & save to Excel ───────────────────
...
def run_search(
    ...
    query = preview_query(keyword_groups)
    ...
    if not all_results:
        print("\n❌ No articles found. Try different keywords or a wider date range.")
        return None
